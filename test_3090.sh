...
python3 main.py --five_classes --batch_size_unet 2 --save_disturbed_dataset --unet_weights_load $MODEL_FW

python3 main.py --five_classes --batch_size_unet 2 --train_model_backward
python3 main.py --five_classes --batch_size_unet 1 --compute_similarity_metrics --unet_weights_load $MODEL_BW
