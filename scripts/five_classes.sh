...
python3 main.py --five_classes --use_dataset_subset $USE_DATASET_SUBSET --batch_size_unet $BATCH_SIZE_UNET --lr_unet $LR_UNET --prop_pos 3 --prop_neg 3 --num_epochs_unet_forward $NUM_EPOCHS_UNET_FORWARD --unet_save_path $UNET_SAVE_PATH --tasknet_weights_load $TASKNET_WEIGHTS_LOAD
...
python3 main.py --five_classes --use_dataset_subset $USE_DATASET_SUBSET --batch_size_unet $BATCH_SIZE_UNET --num_epochs_unet_forward $NUM_EPOCHS_UNET_FORWARD --unet_save_path $UNET_SAVE_PATH --results_dir $RESULTS_DIR --tasknet_weights_load $TASKNET_WEIGHTS_LOAD --not_use_custom_filter_prop --unet_fw_weights_load $UNET_WEIGHTS_LOAD_FW --val_forward_batch1
mv $RESULTS_DIR "${EXPERIMENT_DIR}/3pos3neg_5classes/forward/val_results_batch1"
echo "Completed 3pos3neg_5classes Validation with Batch Size 1"
...
python3 main.py --five_classes --use_dataset_subset $USE_DATASET_SUBSET --test_model --tasknet_weights_load $TASKNET_WEIGHTS_LOAD --unet_fw_weights_load "${EXPERIMENT_DIR}/3pos3neg_5classes/forward/model_fw_50.pt" --unet_bw_weights_load "${EXPERIMENT_DIR}/3pos3neg_5classes/backward/model_bw_80.pt"
mv $RESULTS_DIR "${EXPERIMENT_DIR}/3pos3neg_5classes/test_results"
echo "Completed 3pos3neg_5classes test"
...
python3 main.py --five_classes --use_dataset_subset $USE_DATASET_SUBSET --batch_size_unet $BATCH_SIZE_UNET --lr_unet $LR_UNET --prop_pos 2 --prop_neg 2 --num_epochs_unet_forward $NUM_EPOCHS_UNET_FORWARD --unet_save_path $UNET_SAVE_PATH --tasknet_weights_load $TASKNET_WEIGHTS_LOAD
...
python3 main.py --five_classes --use_dataset_subset $USE_DATASET_SUBSET --batch_size_unet $BATCH_SIZE_UNET --num_epochs_unet_forward $NUM_EPOCHS_UNET_FORWARD --unet_save_path $UNET_SAVE_PATH --results_dir $RESULTS_DIR --tasknet_weights_load $TASKNET_WEIGHTS_LOAD --not_use_custom_filter_prop --unet_fw_weights_load $UNET_WEIGHTS_LOAD_FW --val_forward_batch1
mv $RESULTS_DIR "${EXPERIMENT_DIR}/2pos2neg_5classes/forward/val_results_batch1"
echo "Completed 2pos2neg_5classes Validation with Batch Size 1"
...
python3 main.py --five_classes --use_dataset_subset $USE_DATASET_SUBSET --test_model --tasknet_weights_load $TASKNET_WEIGHTS_LOAD --unet_fw_weights_load "${EXPERIMENT_DIR}/2pos2neg_5classes/forward/model_fw_50.pt" --unet_bw_weights_load "${EXPERIMENT_DIR}/2pos2neg_5classes/backward/model_bw_80.pt"
