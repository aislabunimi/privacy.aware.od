...
mv "${EXPERIMENT_DIR}/tasknet/tasknet_${NUM_EPOCHS_TASKNET}.pt" "${EXPERIMENT_DIR}/tasknet/tasknet_1class.pt"
...
mv $TASKNET_WEIGHTS_FW_TO_SAVE1 "${TASKNET_SAVE_PATH}_1class.pt" #rename needed for other scripts
