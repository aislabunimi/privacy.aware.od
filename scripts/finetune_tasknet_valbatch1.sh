...
python3 main.py --finetune_tasknet --tasknet_weights_load "${EXPERIMENT_DIR}/finetuning_tasknet_on_0.5_MAE/tasknet_10.pt" --use_dataset_subset $USE_DATASET_SUBSET --batch_size_tasknet 1 --batch_size_unet 1 --results_dir $RESULTS_DIR --val_forward_batch1 --train_tasknet --unet_fw_weights_load $UNET
