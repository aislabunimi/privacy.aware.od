...
TASKNET="${EXPERIMENT_DIR}/tasknet/tasknet_1norm_myresize.pt"
UNET="${EXPERIMENT_DIR}/all_proposals/forward/model_fw_50.pt"

python3 main.py --finetune_tasknet --tasknet_weights_load "${EXPERIMENT_DIR}/finetuning_tasknet_on_unetallprop/tasknet_finetuned_10.pt" --use_dataset_subset $USE_DATASET_SUBSET --batch_size_tasknet 1 --batch_size_unet 1 --results_dir $RESULTS_DIR --val_forward_batch1 --unet_fw_weights_load $UNET
...
python3 main.py --finetune_tasknet --tasknet_weights_load "${EXPERIMENT_DIR}/finetuning_tasknet_on_2pos2neg/tasknet_finetuned_10.pt" --use_dataset_subset $USE_DATASET_SUBSET --batch_size_tasknet 1 --batch_size_unet 1 --results_dir $RESULTS_DIR --val_forward_batch1 --unet_fw_weights_load $UNET
...
python3 main.py --finetune_tasknet --tasknet_weights_load "${EXPERIMENT_DIR}/finetuning_tasknet_on_0.8_MAE/tasknet_finetuned_10.pt" --use_dataset_subset $USE_DATASET_SUBSET --batch_size_tasknet 1 --batch_size_unet 1 --results_dir $RESULTS_DIR --val_forward_batch1 --unet_fw_weights_load $UNET
...
python3 main.py --finetune_tasknet --tasknet_weights_load "${EXPERIMENT_DIR}/finetuning_tasknet_on_1pos1neg/tasknet_finetuned_10.pt" --use_dataset_subset $USE_DATASET_SUBSET --batch_size_tasknet 1 --batch_size_unet 1 --results_dir $RESULTS_DIR --val_forward_batch1 --unet_fw_weights_load $UNET
...
python3 main.py --finetune_tasknet --tasknet_weights_load "${EXPERIMENT_DIR}/finetuning_tasknet_on_0.9_MAE/tasknet_finetuned_10.pt" --use_dataset_subset $USE_DATASET_SUBSET --batch_size_tasknet 1 --batch_size_unet 1 --results_dir $RESULTS_DIR --val_forward_batch1 --unet_fw_weights_load $UNET
...
python3 main.py --finetune_tasknet --tasknet_weights_load "${EXPERIMENT_DIR}/finetuning_tasknet_on_0.5_MAE/tasknet_finetuned_10.pt" --use_dataset_subset $USE_DATASET_SUBSET --batch_size_tasknet 1 --batch_size_unet 1 --results_dir $RESULTS_DIR --val_forward_batch1 --unet_fw_weights_load $UNET
