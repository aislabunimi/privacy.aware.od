...
num_epochs=10
vgg16_save_path='/home/math0012/Tesi_magistrale/classifier/classifier'

for epoch in range(1, num_epochs+1): #itero ora facendo un train e un test per ogni epoca
    log['TRAIN_LOSS'].append(train_vgg(train_dataloader, epoch, device, train_loss, vgg16, optimizer))
    #scheduler.step()
    log['VAL_LOSS'].append(val_vgg(val_dataloader, epoch, device, val_loss, vgg16_save_path, vgg16, optimizer, scheduler))
