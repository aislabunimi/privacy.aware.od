...
#from .roi_heads import paste_masks_in_image #removed as I don't work with masks

#####
# CODE MOSTLY COPYPASTED FROM TORCHVISION DETECTION, REMOVED RESIZE AS I DO IT IN DATSET
#####
...
class GeneralizedRCNNTransformRemoved(nn.Module):
    """
