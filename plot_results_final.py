...
def get_args_parser():
   ...
   parser.add_argument('--plot_single_image', action='store_true', default=True, help='If you want to plot only the image alone')
...
def main(args):
   ...
   if args.plot_my_test_data:
      ...
      if args.five_classes:
         ...
         image_name_list = os.listdir('/home/alberti/images_crowded/')
         image_name_list=['frame0476.jpg']
