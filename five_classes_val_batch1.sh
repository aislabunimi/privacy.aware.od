...
python3 main.py --train_tasknet --five_classes --tasknet_weights_load $TASKNET --use_dataset_subset 0 --batch_size_tasknet 1 --results_dir $RESULTS_DIR --val_forward_batch1 --coco_allclasses_path $COCO_ALLCLASSES_PATH --coco_fiveclasses_path $COCO_FIVECLASSES_PATH --pascal_img_path $PASCAL_IMG_PATH
...
python3 main.py --use_dataset_subset 0 --batch_size_unet 1 --results_dir $RESULTS_DIR --tasknet_weights_load $TASKNET --not_use_custom_filter_prop --unet_fw_weights_load "${EXPERIMENT_DIR}/allprop_5classes/forward/model_fw_50.pt" --val_forward_batch1 --five_classes --coco_allclasses_path $COCO_ALLCLASSES_PATH --coco_fiveclasses_path $COCO_FIVECLASSES_PATH --pascal_img_path $PASCAL_IMG_PATH
...
python3 main.py --use_dataset_subset 0 --batch_size_unet 1 --results_dir $RESULTS_DIR --tasknet_weights_load $TASKNET --not_use_custom_filter_prop --unet_fw_weights_load "${EXPERIMENT_DIR}/3pos3neg_5classes/forward/model_fw_50.pt" --val_forward_batch1 --five_classes --coco_allclasses_path $COCO_ALLCLASSES_PATH --coco_fiveclasses_path $COCO_FIVECLASSES_PATH --pascal_img_path $PASCAL_IMG_PATH
...
python3 main.py --use_dataset_subset 0 --batch_size_unet 1 --results_dir $RESULTS_DIR --tasknet_weights_load $TASKNET --not_use_custom_filter_prop --unet_fw_weights_load "${EXPERIMENT_DIR}/2pos2neg_5classes/forward/model_fw_50.pt" --val_forward_batch1 --five_classes --coco_allclasses_path $COCO_ALLCLASSES_PATH --coco_fiveclasses_path $COCO_FIVECLASSES_PATH --pascal_img_path $PASCAL_IMG_PATH
